...
import {SET_USER_SIGN_UP, SET_USER_SIGN_IN, SET_ERRORS_MESSAGE} from '../constants/actionTypesConstant'
...
export const singInUser = ({userEmail, userPlanPassword}, onCallback) => dispatch => {
	console.log("fhgfhg")
	{
	...
	axios({
		method: 'post',
		url: '/user/signin',
		data: {userEmail, userPlanPassword},
		proxy: {
			host: API_CONSTANTS.HOSTNAME,
			port: API_CONSTANTS.PORT
		},
